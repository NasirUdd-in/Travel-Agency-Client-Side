...
const Footer = () => {
    return (
        <div id="contact">
            <div className="bg-dark text-white py-5 text-muted">
                <Container>
                    <Row>
                        ...
                        <Col md={3} >
                            <h1 className="fs-3 pb-2">Follow  Us</h1>
                            <p className="fs-2">
            ...
            <p className="text-center pt-3 fs-5">Copyrights © 2022 <span className="text-info">Travel Agency</span>. All Rights Reserved</p>
